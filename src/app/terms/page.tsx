  ...
  return (
    <main className="min-h-screen bg-black text-zinc-300 px-6 py-16 max-w-2xl mx-auto font-mono text-sm leading-relaxed">
      ...
      <p className="mt-6 text-zinc-400 text-xs">
        WWtellme is an opinion / forecast board. By using the site you agree not
        to abuse voting, spam, or misrepresent results. Content is user opinion,
        not news reporting. We may remove abuse and update these terms.
      </p>
