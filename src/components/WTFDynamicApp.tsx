          ...
          >
            ...
            <div className="flex justify-center gap-1.5 w-full max-w-[340px] flex-wrap">
              <button
                ...
                title="X (Twitter)"
                className="w-9 h-9 bg-zinc-950 rounded-xl border border-zinc-800 hover:border-white/40 transition-all flex items-center justify-center cursor-pointer shadow-md"
              >
              ...
              <button
                ...
                title="Instagram"
                className="w-9 h-9 bg-zinc-950 rounded-xl border border-zinc-800 hover:border-[#E1306C]/60 transition-all flex items-center justify-center cursor-pointer shadow-md"
              >
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" aria-hidden>
                  <defs>
                    <linearGradient
              ...
              <button
                ...
                title="TikTok"
                className="w-9 h-9 bg-zinc-950 rounded-xl border border-zinc-800 hover:border-[#25F4EE]/50 transition-all flex items-center justify-center cursor-pointer shadow-md"
              >
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" aria-hidden>
                  <path
                    fill="#25F4EE"
              ...
              <button
                ...
                title="Telegram"
                className="w-9 h-9 bg-zinc-950 rounded-xl border border-zinc-800 hover:border-[#2AABEE]/50 transition-all flex items-center justify-center cursor-pointer shadow-md"
              >
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" aria-hidden>
                  <path
                    fill="#2AABEE"
              ...
              <button
                ...
                title="WhatsApp"
                className="w-9 h-9 bg-zinc-950 rounded-xl border border-zinc-800 hover:border-[#25D366]/50 transition-all flex items-center justify-center cursor-pointer shadow-md"
              >
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" aria-hidden>
                  <path
                    fill="#25D366"
              ...
              <button
                ...
                title="Facebook"
                className="w-9 h-9 bg-zinc-950 rounded-xl border border-zinc-800 hover:border-[#1877F2]/50 transition-all flex items-center justify-center cursor-pointer shadow-md"
              >
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" aria-hidden>
                  <path
                    fill="#1877F2"
                    d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.37 14.5 5 15.5 5H18V0h-3.808C10.5 0 9 1.583 9 4.615V8z"
                  />
                </svg>
              </button>
              <button
                ...
                title="LinkedIn"
                className="w-9 h-9 bg-zinc-950 rounded-xl border border-zinc-800 hover:border-[#0A66C2]/50 transition-all flex items-center justify-center cursor-pointer shadow-md"
              >
                <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" aria-hidden>
                  <path
                    fill="#0A66C2"
