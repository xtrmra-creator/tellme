        ...
        <div className="relative w-full max-w-lg">
          {isLocked && (
            <div className="absolute inset-0 z-20 bg-black/10 backdrop-blur-[2px] flex flex-col items-center justify-center p-6 text-center animate-in fade-in rounded-3xl">
              ...
              <div className="flex flex-wrap justify-center gap-3 w-full max-w-md mb-4">
                <button
                  type="button"
                  onClick={() => setIsUnlockedWithData(true)}
                  className="flex-1 flex items-center justify-center gap-2 bg-zinc-900/90 hover:bg-zinc-800 text-zinc-300 rounded-xl border border-zinc-700 py-3 px-4 text-[10px] font-mono tracking-wide cursor-pointer transition-colors shadow-xl"
                >
                  <svg
                ...
                >
                  <svg
                    className="w-4 h-4 shrink-0 fill-current text-zinc-100"
                    viewBox="0 0 24 24"
                    aria-hidden
                  >
                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 15.68 2.94 10.18 5.7 6.79c1.37-1.68 3.54-2.66 5.57-2.69 1.29.03 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" />
                  </svg>
                  {t("dynamic.continueApple")}
                </button>
              </div>
